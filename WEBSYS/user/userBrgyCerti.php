...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Collecting and sanitizing the input data
...
<script>
    ...
    function confirmSubmission() {
        if (confirm("Are you sure all information is correct?")) {
            // If user clicks "OK" in the confirmation dialog, proceed with form submission
    ...
    document.getElementById('registrationForm').addEventListener('submit', function(event) {
        // Clear all form fields after a short delay to ensure form submission completes
        setTimeout(function() {
